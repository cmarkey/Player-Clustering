...
# adding positions
pos = pd.read_csv(local_dir+'\player_positions.csv')
...
players = players.fillna(0)
players.to_csv(local_dir+'\player_summary.csv')
...
index_calc_1 = index_calc_1.rename(columns={'Complete Passes_x' : 'Complete Passes', 'Complete Passes_y' : 'Team Complete Passes'})

team_grouping = players.groupby('Team')['Incomplete Passes'].sum()
index_calc_2 = players.merge(team_grouping, on='Team', how='left')
index_calc_2 = index_calc_2.rename(columns={'Incomplete Passes_x' : 'Incomplete Passes', 'Incomplete Passes_y' : 'Team Incomplete Passes'})
...
index_calc_2 = players.merge(team_grouping, on='Team', how='left')
index_calc_2 = index_calc_2.rename(columns={'Played Entries_x' : 'Played Entries', 'Played Entries_y' : 'Team Played Entries'})
index_calc_2 = index_calc_2.fillna(0)
...
indexes['Danger Pass Index'] = (index_calc['Danger Passes']/(index_calc['Team Danger Passes']))#*index_calc['Shot Assists']/index_calc['GP']
...
indexes['Danger Shot Index'] = (index_calc['Danger Shots']/(index_calc['Team Danger Shots']))#*index_calc['Shot Assists']/index_calc['GP']
...
indexes['Takeaways Index'] = (index_calc['Takeaways']/(index_calc['Team Takeaways']))#*index_calc['Shot Assists']/index_calc['GP']
...
indexes['Puck Recovery Index'] = (index_calc['Puck Recoveries']/(index_calc['Team Puck Recoveries']))#*index_calc['Shot Assists']/index_calc['GP']
